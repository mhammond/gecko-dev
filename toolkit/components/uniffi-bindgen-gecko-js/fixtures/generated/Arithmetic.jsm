...
function add(a,b) {
    ...
    const functionCall = () => {
        ...
        return ArithmeticScaffolding.arithmetic475fAdd(FfiConverterU64.lower(a),FfiConverterU64.lower(b),
        )
    }
    try {
...
function sub(a,b) {
    ...
    const functionCall = () => {
        ...
        return ArithmeticScaffolding.arithmetic475fSub(FfiConverterU64.lower(a),FfiConverterU64.lower(b),
        )
    }
    try {
        return functionCall().then((result) => handleRustResult(result,  liftResult, liftError));
...
function div(dividend,divisor) {
    ...
    const functionCall = () => {
        ...
        return ArithmeticScaffolding.arithmetic475fDiv(FfiConverterU64.lower(dividend),FfiConverterU64.lower(divisor),
        )
    }
    try {
        return functionCall().then((result) => handleRustResult(result,  liftResult, liftError));
...
function equal(a,b) {
    ...
    const functionCall = () => {
        ...
        return ArithmeticScaffolding.arithmetic475fEqual(FfiConverterU64.lower(a),FfiConverterU64.lower(b),
        )
    }
    try {
        return functionCall().then((result) => handleRustResult(result,  liftResult, liftError));
