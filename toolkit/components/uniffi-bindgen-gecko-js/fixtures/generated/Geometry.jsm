...
function gradient(ln) {
    ...
    const functionCall = () => {
        ...
        return GeometryScaffolding.geometryEb69Gradient(FfiConverterTypeLine.lower(ln),
        )
    }
    try {
...
function intersection(ln1,ln2) {
    ...
    const functionCall = () => {
        ...
        return GeometryScaffolding.geometryEb69Intersection(FfiConverterTypeLine.lower(ln1),FfiConverterTypeLine.lower(ln2),
        )
    }
    try {
        return functionCall().then((result) => handleRustResult(result,  liftResult, liftError));
